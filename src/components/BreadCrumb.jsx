...
const BreadCrumb = () => {
  return (
    <div className="mx-[15px] md:mx-[100px] mt-12">
      <div className="w-full md:w-[1200px] flex flex-wrap justify-start items-center md:ml-[20px]">
        ...
        <span className=" text-[#696671] font-[500] text-[18px] leading-normal not-italic font-[Inter]">
          Flashcard
        </span>
        <div className="w-[24px] h-[24px]">
          <svg
        ...
        <span className=" text-[#06286E] font-[500] text-[18px] leading-normal not-italic font-[Inter]">
