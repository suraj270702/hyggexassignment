...
const HyggexInfo = () => {
  return (
    <div className="mx-[15px] md:mx-[100px] mt-16">
      <div className="w-full md:w-[1200px] md:ml-[20px]">
        <div className="flex flex-col md:flex-row gap-y-4 md:gap-y-0 items-center justify-between">
          <div className="flex items-center gap-[10px]">
            <div className="w-[48.796px] h-[50.663px] md:w-[98.796px] md:h-[100.663px] rounded-full shadow-lg flex items-center justify-center border">
              <img src={logo} className="" />
            </div>
            <div className="flex flex-col">
              <span className="text-[#696671] not-italic font-[Inter] text-[12.4px] leading-normal font-bold">
                Published by
              </span>
              <div className="w-[115.143px] h-[34.543px]">
                <svg
          ...
          <div className="flex items-center gap-[8px]">
            ...
            <span className="text-[28px] font-[600] not-italic font-[Inter] leading-normal">
              Create Flashcard
            </span>
          </div>
        </div>
